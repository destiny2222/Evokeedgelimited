            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="switch-visa" disabled {{
                            $setting->visa ? 'checked' : '' }}>
                        <label class="form-check-label" for="switch-visa">Visa Fee</label>
                    </div>
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="switch-flight_booking"
                            disabled {{ $setting->flight_booking ? 'checked' : '' }}>
                        <label class="form-check-label" for="switch-flight_booking">Flight Booking</label>
                    </div>
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="switch-tuition" disabled {{
                            $setting->tuition_payment ? 'checked' : '' }}>
                        <label class="form-check-label" for="switch-tuition">Tuition Payment</label>
                    </div>
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="switch-corporate" disabled {{
                            $setting->corporate_service ? 'checked' : '' }}>
                        <label class="form-check-label" for="switch-corporate">Corporate Service</label>
                    </div>
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="switch-merchandise" disabled
                            {{ $setting->merchandise_payment ? 'checked' : '' }}>
