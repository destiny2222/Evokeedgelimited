                ...
                <form action="{{  route('local-store') }}" method="post">
                    ...
                    <div class="form-group mb-4">
                        <label class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="on_way"  value="one way">
                            <span class="custom-control-label">One way</span>
                        </label>
                        <label class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="round_trip" value="Round Trip">
                    ...
                    <div class="form-group  mb-4">
                        <label for="" class="form-label">Flying To</label>
                        ...
                        <div class="form-group col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <select name="infant" class="form-control form-select select2" data-bs-placeholder="Select" required>
                                    <option value="" selected>Infant(under 2Yrs)</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-6 mb-4">
                            ...
                            <input type="date" name="date_birth_date" class="form-control" required>
                        </div>
                        <div class="form-group col-lg-6">
                            <label class="form-label">Nationality</label>
                            <select name="nationality" class="form-control @error('nationality') is-valid @enderror" required>
